...
{		   
	...
	*/
    ...
    public function insert( $propertyname,$propertyvalue,$datatypeid,$createdby,$createddate,$modifiedby,$modifieddate,$deletedby,$deleteddate,$isdeleted,$status)
	{
    ...
    public function update($propertyid,$propertyname,$propertyvalue,$datatypeid,$createdby,$createddate,$modifiedby,$modifieddate,$deletedby,$deleteddate,$isdeleted,$status)
	{
		$strTableName = self::TBL_SL_PROPERTY;
