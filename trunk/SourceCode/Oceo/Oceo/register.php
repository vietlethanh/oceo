			...
			<div class="control-group">
				<div class="controls">
					<label class="checkbox">
						<input type="checkbox" id="chkTerm" value="" /> Tôi đã đọc và đồng ý với <a href="<?php echo global_common::PAGE_TERM_GENERAL ?>" class="link">điều khoản sử dụng</a>  của hệ thống oceo.vn
					</label>
